...
* [Go Slice Tricks](https://jusths.tistory.com/m/155)
...
* [motlabs](https://github.com/motlabs): We try to provide a guide for embedding own CNN model in your mobile Apps. or IoT devices
...
* [대학원생 때 알았더라면 좋았을 것들](http://gradschoolstory.net/)
  ...
  * [영어 못해도 논문 잘 쓰는 법](http://gradschoolstory.net/terry/englishpaperwriting/)
* [서울대 로보틱스 랩 졸업생모임](http://t-robotics.blogspot.com/): 엄태웅님의 딥러닝 글 모음
* [코랩 시작하기](https://tykimos.github.io/2019/01/22/colab_getting_started/?fbclid=IwAR0tB41B_VF9-7BsdStB9K66c5IXBciJN0veW8QWt3yuH44G0zCLvcZPPOk): 김태영님의 케라스 글 모음
* [IDL 랩의 포트폴리오](https://vega.github.io/): `Vega`는 물론, `Voyager` 와 `Datalib`를 살펴볼만 하다.
